...
aftS = nptS * 0.1 - preS
devc = try_gpu(i=10)
workdir = '/Users/qibin/Projects/Petrolia_2021/ptr_raw/0_tel_wilber3_pendingprocess/'
sac_dir = 'rot_dir'
mkdir(workdir + 'denoised_mergedPS_' + sac_dir)
mod_file = 'Branch_Encoder_Decoder_LSTM_Model.pth'
P_model = 'Release_Middle_augmentation_P4Hz_150s/' + mod_file
S_model = 'Release_Middle_augmentation_S4Hz_150s_removeCoda_SoverCoda20_1980-2021-include-noFMS/' + mod_file

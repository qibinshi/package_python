...
data_dir = '/Users/qb/projects/DenoTe/codes_data_results/tilt_event_2022-07-23T11_40_45/not_rotated/VEL_not_rotated'
mkdir(data_dir + '/denoised')
npts = 1500
preP = 50.0
...
stalist = glob.glob(sac_dir + '/*.Z')
print('Number of stations: ', len(stalist), stalist)
...
for j in range(denoised_signal.shape[0]):
    ...
    for i in range(3):
        ...
        st[i].write(data_dir + '/denoised/'+nt+'.'+nm+'.'+lc+'.'+ch, format='SAC')
